...
class CalculationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calculation" do
    assert_difference('Calculation.count') do
      post calculations_url, params: { calculation: { description: @calculation.description, value: @calculation.value } }
    end
  ...
  test "should update calculation" do
    patch calculation_url(@calculation), params: { calculation: { description: @calculation.description, value: @calculation.value } }
